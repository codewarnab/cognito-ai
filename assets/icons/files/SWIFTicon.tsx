...
export const SwiftIcon: React.FC<SwiftIconProps> = ({ size = 24 }) => {
  ...
  return (
    ...
    >
      <motion.svg
        ...
        viewBox="0 0 24 24"
        role="img"
        aria-label="Swift programming language file icon"
        variants={{
      ...
      >
        {/* File shape background with a Swift-inspired orange color */}
        <path
