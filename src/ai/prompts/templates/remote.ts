...
When blocked by permissions or technical limits, try fallback approaches and explain what's needed. Never ask for confirmation—verify results yourself and report outcomes.',
        value: {
            ...
            toolPlaybook: [
                ...
                "  - ❌ DOES NOT SUPPORT LOCAL FILES: Cannot analyze local file paths (file://, file:///C:/Users/..., blob:, etc.)",
                "  - ✅ ONLY SUPPORTS PUBLIC URLs: Works only with publicly accessible PDFs (https://example.com/document.pdf)",
                "  - LOCAL FILE DETECTION: If you detect a local file path (file://, file:///C:/, blob:), DO NOT attempt analysis",
                "  - REDIRECT TO ATTACHMENT: When local file detected, respond with:",
                ...
                "  - LOCAL FILE EXAMPLES TO REJECT:",
                "    * file:///C:/Users/User/Downloads/document.pdf → ASK FOR ATTACHMENT",
                "    * file://localhost/Users/..., blob:https://... → ASK FOR ATTACHMENT",
                "    * Any path starting with 'file://' or 'blob:' → ASK FOR ATTACHMENT",
