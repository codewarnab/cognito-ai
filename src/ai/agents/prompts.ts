...
import { getBrowserCapabilitiesSummary } from './browserActionAgent';
...
/**
 * ============================================================================
 * CAPABILITIES SUMMARY (Embedded in Prompt #1)
 * ============================================================================
 * 
 * This is generated by getBrowserCapabilitiesSummary() in browserActionAgent.ts
 * It gets embedded in the Gemini Live system instruction to tell the voice AI
 * what capabilities are available.
 * 
 * Re-exported here for clarity, but the actual implementation is in browserActionAgent.ts
 */
export { getBrowserCapabilitiesSummary };
